...
AI Data Platforms: Databricks, Spark, cloud-native lakehouse design

MLOps & DevOps: Model serving, CI/CD, Kubernetes-based deployments
...
Production-grade ETL/ELT using PySpark & SQL at scale

Cloud-native design across AWS, Azure, and Databricks

LLM-powered applications (Text-to-SQL, RAG, Vector Search)

Operational excellence: observability, cost optimization, reliability
...
Data modeling for analytics & AI workloads
...
LLM-based data interaction (NL → SQL → Insights)

Platform & DevOps

Dockerized services & CI/CD pipelines
...
LLM + Data Engineering use cases (Text-to-SQL, RAG, analytics agents)

Clean, modular, enterprise-ready codebases
...
💼 Open to discussions on AI Data Platforms, MLOps, and AI-driven products
